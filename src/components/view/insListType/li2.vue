...
<template>
  <div class="listView">
    <div class="by">人保试管婴儿手术保险为您保驾护航</div>
    <div class="box2">
      <div class="li li1">
    ...
    <div class="box3">
      <div class="title">这份保险的价值</div>
      <div class="liBox">
        <img src="@/assets/li2_i2.png" alt="">
        <div class="bgs">
          <div class="li">
            <div class="y"></div>
            <div class="text1">手术不成功</div>
            <div class="text2">治疗费用由保险公司赔付</div>
          </div>
          <div class="li">
            <div class="y"></div>
            <div class="text1">减轻经济负担和精神压力</div>
            <div class="text2">以轻松心态接受治疗，提高成功率</div>
          </div>
          <div class="li">
            <div class="y" style="top: 3px;"></div>
            <div class="text1">在求子之路上更有保障</div>
          </div>
        </div>
      </div>
    </div>
    <div class="box4">
      ...
      <img class="im3" src="@/assets/li2_i3.png" alt="">
    </div>
    <div class="box4">
    ...
    <div class="box4">
      ...
      <img class="im5" src="@/assets/li2_i5.png" alt="">
    </div>
    <div class="box4">
